...
package com.cxc.firstproject.view;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public static final int DEF_VALUE_TAB_TEXT_ALPHA = 120;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int textPrimaryColor = a.getColor(TEXT_COLOR_PRIMARY, ContextCompat.getColor(context, R.color.maincolor));
    ...
    private void unSelect(View tab) {
        if (tab != null) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextColor(getContext().getResources().getColor(R.color.tx_Black));
            }
    ...
    private void select(View tab) {
        if (tab != null) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextColor(getContext().getResources().getColor(R.color.maincolor));
            }
